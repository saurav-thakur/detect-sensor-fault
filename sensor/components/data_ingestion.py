...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            dataframe = sensor_data_class.export_collection_as_dataframe(collection_name=self.data_ingestion_config.collection_name)
    ...
    def split_data_as_train_test(self,dataframe:DataFrame):
        """
        Feature store data will be splitted in train and test 
        """
        try:
